...
SECRET_KEY = '-0qdge2gd43haz5rq1gtn3sa2^i^bqbdlie8)68q@z)%vrpjc2'
...
# D:\social_blog\social_blog\main\images
# MEDIA_ROOT =  os.path.join(BASE_DIR, 'media/')
MEDIA_ROOT = "D:\\social_blog\\social_blog\\main\\static\\media"
MEDIA_URL = 'media/'
